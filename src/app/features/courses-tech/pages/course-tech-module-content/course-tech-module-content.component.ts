...
@Component({
  selector: 'app-course-tech-module-content',
  standalone: true,
  imports: [
  ...
  templateUrl: './course-tech-module-content.component.html',
  styleUrl: './course-tech-module-content.component.scss'
})
export class CourseTechModuleContentComponent implements OnInit {
